...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerRegister: async (loginRequestOTPDto: LoginRequestOTPDto, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'loginRequestOTPDto' is not null or undefined
            assertParamExists('authControllerRegister', 'loginRequestOTPDto', loginRequestOTPDto)
...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async authControllerRegister(loginRequestOTPDto: LoginRequestOTPDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerRegister(loginRequestOTPDto, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const AuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerRegister(loginRequestOTPDto: LoginRequestOTPDto, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.authControllerRegister(loginRequestOTPDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Resend OTP to user
...
export class AuthApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public authControllerRegister(loginRequestOTPDto: LoginRequestOTPDto, options?: RawAxiosRequestConfig) {
        return AuthApiFp(this.configuration).authControllerRegister(loginRequestOTPDto, options).then((request) => request(this.axios, this.basePath));
    }
